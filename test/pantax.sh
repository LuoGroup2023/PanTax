...
# create index only (default is short read index)
$pantax -f ../example_genomes_info.txt --index -t 32

# perform profiling (species)
$pantax -s -p -r short_reads.fq.gz --species -n -t 32

# perform profiling (strain)
$pantax -s -p -r short_reads.fq.gz --strain -n -t 32
