...
pub fn rcls_profile(input_file: &InputFile) -> PolarsResult<DataFrame> {
    ...
    let output_df = process_reads_parallel_simple(&gaf_df, &species_info, &regex)?;    
    Ok(output_df)
}

// pub fn rcls(args: RclsArgs) -> Result<()> {
